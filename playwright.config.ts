...
//
// W3: SMOKE_PORT is validated and NORMALIZED before it ever reaches an interpolation. The raw env string
...
export default defineConfig({
  ...
  // never land on the next free port and desync from baseURL (the same port/URL-coherence W3 guards).
