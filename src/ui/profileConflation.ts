// The profile-conflation tripwire (a design rider) — THE single source of the scan pattern.
//
...
// (the rendered f3a card) — so the tripwire can never drift between unit and e2e.
//
